...
class cm_reader:
    def __init__(self):
        ...
        self.model_list = {
            ...
            'basti_co_da_10_nps':
            'Salari et al. 2010 CO DA, no phase separation',
            'basti_co_db_10_nps':
            'Salari et al. 2010 CO DB, no phase separation',
    ...
    def _althaus07_formatter(self):
        ...
        column_key = np.array(
            ('lum', 'logg', 'B-V', 'V-R', 'V-K', 'R-I', 'J-H', 'H-K', 'V-I',
             'U-V', 'BC', 'dmag_v', 'age'))
    ...
    def _althaus09_formatter(self, mass_range='all'):
        ...
        # Prepare the array column dtype
        column_key = np.array(
            ('Teff', 'logg', 'lum', 'age', 'BC', 'M_V', 'U', 'B', 'V', 'R',
             'I', 'J', 'H', 'K', 'L', 'U-B', 'B-V', 'V-K', 'V-I', 'R-I', 'J-H',
             'H-K', 'K-L'))
        column_key_formatted = np.array(
            (r'T$_{\mathrm{eff}}$', 'log(g)', 'Luminosity', '$log(Age)$',
             '$Bolometric Correction$', r'$V$', r'$U$', r'$B$', r'$V$', r'$R$',
             r'$I$', r'$J$', r'$H$', r'$K$', r'$L$', r'$U-B$', r'$B-V$',
             r'$V-K$', r'$V-I$', r'$R-I$', r'$J-H$', r'$H-K$', r'$K-L$'))
        column_key_unit = np.array(
    ...
    def _althaus15_formatter(self, model):
        ...
        column_key_formatted = np.array(
            ('Luminosity', r'log(T$_{\mathrm{eff}})$', r'T$_{\mathrm{c}}$',
             ...
             r'log(M$_{H, tot}$)', r'log(Mass$_{\mathrm{He Buffer}}$)',
        ...
        column_key_unit = np.array(
            (r'L$_{\odot}$', '(K)', r'($10^6$ K)', r'(g/cm$^3$)', '', '', '%',
             '%', '($10^6$ K)', r'M$_\odot$', r'(M$_\odot$ / yr)', '',
             r'L$_{\odot}$', r'L$_{\odot}$', r'L$_{\odot}$', r'L$_{\odot}$',
             '', r'L$_{\odot}$', r'M$_{\odot}$', r'M$_{\odot}$',
             r'M$_{\odot}$', r'M$_{\odot}$', r'(cm/s$2^$)', r'R$_{\odot}$',
             'erg/s', 'erg/s'))
        column_type = np.array(([np.float64] * len(column_key)))
        dtype = [(i, j) for i, j in zip(column_key, column_type)]
    ...
    def _althaus17_formatter(self, model, mass_range='all'):
        ...
        column_key_formatted = np.array(
            ('Luminosity', r'log(T$_{\mathrm{eff}})$', r'T$_{\mathrm{c}}$',
             ...
             r'log($L_{CNO}$)', r'log($L_{He}$)', r'log($L_{CC}$)',
             r'$\int\frac{\D{S}}{\D{t}}$', r'log($L_{\nu}$)',
             r'log(M$_{H, tot}$)', r'Mass$_{\mathrm{He Buffer}}$',
             r'Mass$_{\mathrm{H-free Core}}$',
             r'Mass$_{\mathrm{He-free Core}}$', 'log(g)', 'Radius',
             'Latent Heat', 'Phase Separation'))
        column_key_unit = np.array(
            (r'L$_{\odot}$', '(K)', r'($10^6$ K)', r'(g/cm$^3$)', '', '', '%',
             '%', '($10^6$ K)', r'M$_\odot$', r'(M$_\odot$ / yr)', '',
    ...
    def _bedard20_formatter(self, model, mass_range='all'):
        ...
        # Prepare the array column dtype
        column_key = np.array(('step', 'Teff', 'logg', 'r', 'age', 'lum',
    ...
    def _camisassa17_formatter(self):
        ...
        column_key_unit = np.array(
            (r'L$_{\odot}$', '(K)', r'($10^6$ K)', r'(g/cm$^3$)', '', '', '%',
             ...
             r'L$_{\odot}$', r'L$_{\odot}$', r'L$_{\odot}$', r'L$_{\odot}$',
             r'L$_{\odot}$', r'L$_{\odot}$', r'M$_{\odot}$', r'M$_{\odot}$',
             r'M$_{\odot}$', r'M$_{\odot}$', r'(cm/s$^2$)', r'R$_{\odot}$'))
        column_type = np.array(([np.float64] * len(column_key)))
        dtype = [(i, j) for i, j in zip(column_key, column_type)]
    ...
    def _camisassa19_formatter(self, model):
        ...
        column_key_unit = np.array(
            (r'L$_{\odot}$', '(K)', r'($10^6$ K)', r'(g/cm$^3$)', '', '', '%',
             '%', r'M$_\odot$', r'(M$_\odot$ / yr)', r'L$_{\odot}$',
             r'M$_{\odot}$', r'(cm/s$^2$)', r'R$_{\odot}$', 'erg/s', 'erg/s'))
        column_type = np.array(([np.float64] * len(column_key)))
        dtype = [(i, j) for i, j in zip(column_key, column_type)]
    ...
    def _lauffer18_formatter(self, model):
        ...
        column_key_formatted = np.array(
            (r'log(T$_{\mathrm{eff}})$', 'Luminosity', 'log(g)', r'Radius',
             'Mass', 'log(Cooling Age)', 'log(Total Age)'))
        column_key_unit = np.array(
            ('(K)', r'L$_{\odot}$', r'(cm/s$^2$)', r'R$_{\odot}$',
             r'M$_\odot$', r'(Gyr)', r'(Gyr)'))
        column_type = np.array(([np.float64] * len(column_key)))
        dtype = [(i, j) for i, j in zip(column_key, column_type)]
    ...
    def _panei07_formatter(self, model):
        ...
        column_key_formatted = np.array(
            (r'log(T$_{\mathrm{eff}})$', 'log(g)', 'Luminosity', 'log(Age)',
             'u', 'g', 'r', 'i', 'z'))
        column_key_unit = np.array(
            ('(K)', r'(cm/s$^2$)', r'L$_{\odot}$', r'(Gyr)', 'mag', 'mag',
             'mag', 'mag', 'mag'))
        column_type = np.array(([np.float64] * len(column_key)))
        dtype = [(i, j) for i, j in zip(column_key, column_type)]
    ...
    def _renedo10_formatter(self, model):
        ...
        # Prepare the array column dtype
        column_key = np.array(
            ('lum', 'Teff', 'logTc', 'logrhoc', 'age', 'mass', 'lumpp',
             'lumcno', 'lumhe', 'lumnu', 'logH', 'logg', 'rsun'))
        column_key_formatted = np.array(
    ...
    def _salaris10_formatter(self, model, mass_range='all'):
        ...
        column_key_formatted = np.array(
            ('log(Age)', 'Mass', r'log(T$_{\mathrm{eff}})$', 'Luminosity', 'u',
             'g', 'r', 'i', 'z'))
        column_key_unit = np.array(
            ('(Gyr)', r'M$_{\odot}$', '(K)', r'L$_{\odot}$', 'mag', 'mag',
             'mag', 'mag', 'mag'))
        column_type = np.array(([np.float64] * len(column_key)))
        dtype = [(i, j) for i, j in zip(column_key, column_type)]
